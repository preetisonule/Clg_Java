...
JOptionPane.showMessageDialog(this,"you are successfully 
registered","Register",JOptionPane.INFORMATION_MESSAGE);
 }
if(e.getSource()==b2)
{ u=t1.getText();
p=tpw.getText();
ResultSet rs=st1.executeQuery("select * from logint where 
